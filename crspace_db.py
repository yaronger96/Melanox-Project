...
class crspace_and_nic: #key=CrSpcae , value=nic 
    CrSpace_dict = {
        '/dev/mst/mt4119_pciconf0': 'crspace_shomron',
        '/dev/mst/mtXXXX_pciconf0': 'crspace_dotan',
        '/dev/mst/mtXXXX_pciconf0': 'crspace_galil',
        '/dev/mst/mtXXXX_pciconf0': 'crspace_bluefield',
        '/dev/mst/mtXXXX_pciconf0': 'crspace_negev',
